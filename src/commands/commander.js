...
module.exports = {
    ...
    handler: ('message', message => {
        ...
        if ( (msg.startsWith(prefix+'aethe') || msg.startsWith(prefix+'athe'))) {
            ...
            msgs.send({ files: [file.dragonFile], embed: commander.dragon})
        }
            ...
            msgs.send({ files: [file.gengisFile], embed:commander.gengis })
        }
            ...
            msgs.send({ files: [file.elcid1File], embed:commander.elcid1 })
        }
        else if ( msg.startsWith(prefix+'el')) {
            msgs.send({ files: [file.elcid2File], embed:commander.elcid2 })
        }
        else if ( msg.startsWith(prefix+'meh') && msg.endsWith('rally'))  {
            msgs.send({ files: [file.mehmed1File], embed:commander.mehmed1 })
        }
        else if ( msg.startsWith(prefix+'meh')) {
            msgs.send({ files: [file.mehmed2File], embed:commander.mehmed2 })
        }
            ...
            msgs.send({ files: [file.herman1File], embed:commander.herman1 })
        }
        else if ( msg.startsWith(prefix+'her') && msg.endsWith('arch'))  {
            msgs.send({ files: [file.herman3File], embed:commander.herman3 })
        }
        else if ( msg.startsWith(prefix+'her')) {
            msgs.send({ files: [file.herman2File], embed:commander.herman2 })
        }
        else if ( msg.startsWith(prefix+'eul') && msg.endsWith('infantry'))  {
            msgs.send({ files: [file.eulji3File], embed:commander.eulji3 })
        }
        else if ( msg.startsWith(prefix+'eul') && msg.endsWith('garri'))  {
            msgs.send({ files: [file.eulji1File], embed:commander.eulji1 })
        }
        else if ( msg.startsWith(prefix+'eul')) {
            msgs.send({ files: [file.eulji2File], embed:commander.eulji2 })
        }
